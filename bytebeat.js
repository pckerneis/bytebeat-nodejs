...
const { sin, cos, tan, abs, floor, ceil, round, min, max, pow, sqrt, random, PI, E } = Math;
const context = createContext({ t: 0, Math, sin, cos, tan, abs, floor, ceil, round, min, max, pow, sqrt, random, PI, E });
